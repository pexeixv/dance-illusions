          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-400 leading-relaxed max-w-lg">
                Learn Ballroom, Latin and Social dancing from professional
                instructors in Goa. Unleash your inner rhythm and join our
                vibrant community.
              </p>
        ...
        <div className="container max-w-7xl mx-auto px-6 mb-12">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-slate-400 text-lg">
              Hear what our vibrant community has to say about their journey
              with us.
            </p>
          </div>
        </div>
        ...
        <div className="container max-w-4xl mx-auto px-6">
          ...
          <div className="mt-16 glass-card p-10 text-center space-y-6 border-cyan-500/20 hidden">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              Feel free to reach out to us directly via WhatsApp for a quick
              response.
            </p>
