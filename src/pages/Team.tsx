              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                <div className="aspect-square relative overflow-hidden">
                  ...
                  <div className="absolute bottom-6 left-6 flex gap-3">
                    <a
                      ...
                      className="w-10 h-10 rounded-full bg-black/40 backdrop-blur-xl border border-white/10 flex items-center justify-center text-white hover:text-purple-400 hover:border-purple-400/50 transition-all"
                    >
                      <Instagram size={18} />
                    </a>
                    <a
                ...
                <div className="p-8 space-y-6">
                  <div className="space-y-1">
                    ...
                    <p className="text-purple-400 font-medium text-sm uppercase tracking-widest">
                      {member.role}
                    </p>
                  </div>
