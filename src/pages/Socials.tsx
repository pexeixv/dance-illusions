    ...
    <div className="pt-32 pb-24">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
          ...
          >
            Experience the joy of social dancing in a relaxed, friendly environment. Practice your skills, meet new people, and have a blast!
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
            ...
            <p className="text-xl text-slate-400 leading-relaxed">
              Social dance nights are community gatherings where students and dance enthusiasts come together to practice in a relaxed environment. It's not a class, but a chance to dance, socialize, and enjoy the music.
            </p>
        ...
        <div className="mb-32">
          <div className="flex items-center justify-between mb-12">
            ...
            <a href="tel:+919823012345" className="text-purple-400 font-bold hover:text-purple-300 transition-colors flex items-center gap-2">
              Inquire for More
              <ArrowRight size={20} />
            </a>
          </div>
