...
export function UpcomingClassesPopup() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Trigger after user scrolls past first viewport
      ...
      <AnimatePresence>
        {false && showTrigger && !isOpen && (
          <motion.button
            ...
            className="fixed z-40 flex items-center gap-2 px-4 py-3 text-white shadow-2xl bottom-6 right-6 rounded-2xl bg-gradient-to-r from-purple-600 to-fuchsia-600 shadow-purple-500/30 hover:scale-105 active:scale-95"
          >
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/10 bg-gradient-to-r from-purple-600/20 to-fuchsia-600/20">
                <div>
                  <p className="text-sm font-medium text-purple-300">June-July 2026</p>

                  <h3 className="mt-1 text-xl font-bold text-white">Upcoming Classes</h3>
                </div>
              ...
              <div className="p-6 space-y-5">
                <p className="text-sm leading-relaxed text-slate-400">
                  As the monsoon rhythms roll in, step into a season of movement and magic with our
                  exciting June-July sessions! Whether you're a beginner taking your very first
                  steps or a dancer looking to sharpen your skills, we've got the perfect class
                  waiting for you.
                </p>
