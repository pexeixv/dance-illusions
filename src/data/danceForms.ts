...
export const danceForms: DanceForm[] = [
  ...
  },
  {
    ...
    category: "Latin",
    description:
      "Playful, energetic and rhythmic. Syncopated steps and lively character.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Latin",
    description:
      "The festive spirit of Brazil. High energy and bouncing rhythm.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Latin",
    description:
      "Fast-paced and energetic. Kicks, flicks, and high-octane fun.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Ballroom",
    description:
      "Elegant and graceful. Smooth, flowing movements across the floor.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Ballroom",
    description:
      "Fast and whirling. A classic dance of the European ballrooms.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Ballroom",
    description:
      "Passionate and dramatic. Sharp movements and intense connection.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Ballroom",
    description:
      "Smooth and sophisticated. A classic social dance of the big band era.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Social",
    description:
      "Vibrant and rhythmic. Roots in Cuban and Caribbean traditions.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Social",
    description:
      "Sensual and melodic. A romantic dance from the Dominican Republic.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Social",
    description:
      "Fun and accessible. A popular social dance for all occasions.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Ballroom",
    description:
      "Fast and powerful. A light-hearted dance with hops and skips.",
    fullDescription:
  ...
  },
  {
    ...
    category: "Social",
    description:
      "The heartbeat of the Dominican Republic. Simple, rhythmic, and fun.",
    fullDescription:
